...
import {CheckCircleOutlined, FallOutlined, LoadingOutlined, RiseOutlined} from "@ant-design/icons";
...
export const Dashboard = () => {
    ...
    const completedTasks = task.Tasks?.filter((task:Task) => task.taskStatus?.toString().toLowerCase() === 'ended').length;
    const pendingTasks = totalTasks - completedTasks;
    const notStartedTasks:number = task.Tasks?.filter((task:Task)=>task.taskStatus?.toString().toLowerCase() ==="not started").length;
